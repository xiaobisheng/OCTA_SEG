...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=str, default='cuda', help='gpu ids')
        ...
        parser.add_argument('--modality_filename', type=list,
                            default=['OCTA(FULL)', 'OCTA(OPL_BM)', 'OCTA(ILM_OPL)', 'OCTA_dccm_10', 'OCTA_dcim_10', 'GT_MultiTask'],
        ...
        parser.add_argument('--in_channels', type=int, default=5, help='input channels')
